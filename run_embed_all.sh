...
for stage in "3 st5-base sentence-transformers/sentence-t5-base" "2 st5-large sentence-transformers/sentence-t5-large" "3 st5-large sentence-transformers/sentence-t5-large" "99 st5-base sentence-transformers/sentence-t5-base" "99 st5-large sentence-transformers/sentence-t5-large"; do
  set -- $stage
